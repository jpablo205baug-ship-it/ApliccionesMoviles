...
const CIUDADES_PRUEBA = [
  // Top 10 Ciudades más turísticas del mundo
  //Thailandia (20.05 millones de visitantes)
  { nombre: 'Bangkok', lat: 13.752428, lon: 100.522748 },
  // Reino Unido (19.83 millones de visitantes)
  { nombre: 'Londres', lat: 51.506999, lon: -0.127782 },
  // Francia (17.44 millones de visitantes)
  { nombre: 'Paris', lat: 48.854035, lon: 2.348881 },
  // Emiratos Árabes (15.79 millones de visitantes)
  { nombre: 'Dubai', lat: 25.202357, lon: 55.263152 },
  // singapur (13.91 millones de visitantes)
  { nombre: 'Singapur', lat: 1.357804, lon: 103.864551 },
  // Estados Unidos (13.13 millones de visitantes)
  { nombre: 'Nueva York', lat: 40.726809 , lon: -73.881316 },
  // Malasia (12.58 millones de visitantes)
  { nombre: 'Kuala Lumpur', lat: 3.146235, lon: 101.696789 },
  // Japón (11.93 millones de visitantes)
  { nombre: 'Tokio', lat: 35.681409, lon: 139.766881 },
  // Turquía (10.70 millones de visitantes)
  { nombre: 'Estambul', lat: 41.009017, lon: 28.949164 },
  // Corea del Sur (9.54 millones de visitantes)
  { nombre: 'Seúl', lat: 37.547990, lon: 126.995637 }
];
  ...
  return (
    ...
    <View style={[styles.contenedor, { backgroundColor: infoVisual.fondo }]}>
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <Text style={styles.tituloPruebas}>Ciudades más turísticas del mundo:</Text>
